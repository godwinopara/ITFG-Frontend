...
export const SubscriptionCard = ({ plan, roi, planAmount, handleClick }: SubscriptionCardProps) => {
	return (
		<div className="rounded-md  bg-boxdark text-white py-4 px-7 shadow-default dark:border-strokedark dark:bg-boxdark">
			<div className="my-1 flex items-end justify-between">
				<div className="w-full">
					<h4 className="text-sm font-bold text-white dark:text-white mb-1">{plan}</h4>
					<div>
					...
					<div className="my-8 w-full">
						<label className="mb-2 block  dark:text-white">Amount</label>
						<input
							type="text"
							required
