        ...
        <div className="grid xl:flex items-center gap-20">
          ...
          <div className="w-full">
            <div className=" mb-16">
              ...
              <p className="text-xl">Index Trade Financial Group has a variety of features that set us apart</p>
            </div>
...
const FeatureCard = ({ title, description, icon }: FeatureCardProps) => {
  return (
    <div className="mb-10 px-4 xl:px-0 lg:flex gap-x-6 items-start">
      <div className="inline-block mb-4 text-3xl text-white bg-primary rounded-[100%] p-4 lg:mb-0 lg:block">{icon}</div>
      <div>
