    ...
    <header className="px-6 py-6  xl:hidden">
      ...
      >
        ...
        <li className="relative " onClick={() => setIsEducationMenuOpen(!isEducationMenuOpen)}>
          <div className="font-medium text-lg hover:text-primary-hover cursor-pointer">Education</div>
          <ul className={`px-4 flex flex-col gap-y-4 mt-5 ${isEducationMenuOpen ? "block" : "hidden"}`}>
            <li>
