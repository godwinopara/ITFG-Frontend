...
export default function Partners() {
  ...
  return (
    <section className="max-w-7xl mx-auto my-24">
      <h3 className="font-extrabold text-3xl mb-10">Who Trusts Index Trade Financial Group</h3>
      <div className="grid grid-cols-3 items-center gap-x-10">
        <PartnersCard title="Media" description="Recognised by global mainstream media" images={mediaImages} />
        <PartnersCard
          title="Licenses"
