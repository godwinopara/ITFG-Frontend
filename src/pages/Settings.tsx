                ...
                <form onSubmit={handleUpdateUserInfo} className="p-7">
                  ...
                  <div className="mb-5 flex flex-col gap-5 sm:flex-row">
                    <div className="w-full sm:w-1/2 mb-5.5">
                      <label className="mb-3 block text-sm font-medium" htmlFor="mobile">
                        Phone Number
                      </label>
                      <input
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <div>
                        <input
                          className="w-full rounded border bg-transparent  bg-gray py-3 px-4  focus:border-primary-hover  focus-visible:outline-none"
                          type="text"
                          name="country"
                          required
                  ...
                  <div className="mb-5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full rounded border bg-transparent focus:border-primary-hover  bg-gray py-3 pl-10 pr-4 focus-visible:outline-none"
                        type="email"
                        name="emailAddress"
                        required
