  ...
  return (
    <section className="px-6 xl:px-0">
      <div className="text-center mb-5">
        <h2 className="text-3xl lg:text-4xl mb-5 font-bold">Accounts tailored to your trading style</h2>
        <p className="xl:w-[40%] mx-auto">
          Index Financial Trade Group has accounts for both new and more active traders. Check which fits and you’re set
          to go.
        </p>
      </div>
